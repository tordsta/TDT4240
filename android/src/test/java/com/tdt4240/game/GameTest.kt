...
import com.tdt4240.game.ecs.component.NetworkIdProvider.Companion.instance
    ...
    companion object {
        ...
        fun init() {
           ...
           Gdx.gl = Gdx.gl20
            ...
            // mock the networking stuff
            val mocked_instance = Mockito.mock(NetworkIdProvider::class.java)
            Mockito.`when`(mocked_instance.getNewId()).thenReturn("")
